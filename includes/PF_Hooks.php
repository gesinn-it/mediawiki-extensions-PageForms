...
class PFHooks {
	...
	public static function initialize() {
		...
		$hookContainer->register( 'PageSaveComplete', 'PFHooks::setPostEditCookie' );
		$hookContainer->register( 'MultiContentSave', 'PFFormUtils::purgeCache2' );
