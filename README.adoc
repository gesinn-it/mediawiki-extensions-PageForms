...
Unresolved directive in README-source.adoc - include::docs/gesinn-it-docs-master-pub/snippets/semver.adoc[]

Unresolved directive in README-source.adoc - include::docs/gesinn-it-docs-master-pub/sections/contributing.adoc[]
